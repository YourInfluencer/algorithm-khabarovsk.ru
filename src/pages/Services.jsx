...
export default function Services() {
  ...
  return (
    <>
      <Seo
        title="Услуги"
        description="Услуги ремонта и настройки техники в Хабаровске: телевизоры, компьютеры и ноутбуки, принтеры/МФУ, Wi-Fi/сеть, IP-камеры, телефоны и планшеты. Быстрый выбор проблемы и заявка."
        path="/services"
      />
